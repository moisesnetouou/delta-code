...
export const skillsStyles = tv({
  slots: {
    ...
    coreBadge:
      "flex items-center gap-2.5 px-4 py-3 md:px-5 md:py-3.5 rounded-xl bg-surface border border-accent-primary/20 hover:border-accent-primary/50 hover:bg-surface/80 hover:scale-[1.03] active:scale-[0.97] transition-[background-color,border-color,transform] duration-200 cursor-pointer group",
    ...
    skillItem:
      "flex flex-col items-center justify-center gap-1.5 md:gap-2 p-3 md:p-4 rounded-xl bg-surface/50 border border-foreground-muted/10 enabled:hover:border-accent-primary/40 enabled:hover:bg-surface enabled:hover:scale-[1.03] enabled:active:scale-[0.97] transition-[background-color,border-color,transform] duration-200 cursor-pointer group min-h-[80px] md:min-h-[100px]",
