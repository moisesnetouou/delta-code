export const skillsStyles = {
  ...
  skillItem: `
    flex flex-col items-center justify-center gap-1.5 md:gap-2 p-3 md:p-4 rounded-xl 
    bg-surface/50 border border-foreground-muted/10 
    hover:border-accent-primary/40 hover:bg-surface 
    transition-all duration-200 cursor-pointer group min-h-[80px] md:min-h-[100px]
  `,
