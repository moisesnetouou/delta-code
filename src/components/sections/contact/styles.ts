export const contactStyles = {
  ...
  primaryButton: `
    inline-flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-full 
    bg-accent-primary text-background font-semibold 
    hover:bg-accent-primary/90 transition-all duration-300 
    hover:scale-105 hover:shadow-lg hover:shadow-accent-primary/25
  `,
  secondaryButton: `
    inline-flex items-center gap-2 px-5 md:px-6 py-2.5 md:py-3 rounded-lg 
    bg-surface border border-accent-primary/20 
